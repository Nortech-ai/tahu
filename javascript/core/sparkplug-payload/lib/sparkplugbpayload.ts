...
type IParameter =
  IProtoRoot.org.eclipse.tahu.protobuf.Payload.Template.IParameter;
type IDataSet = IProtoRoot.org.eclipse.tahu.protobuf.Payload.IDataSet;
type IDataSetValue =
  IProtoRoot.org.eclipse.tahu.protobuf.Payload.DataSet.IDataSetValue;
type IRow = IProtoRoot.org.eclipse.tahu.protobuf.Payload.DataSet.IRow;
type IPropertyValue =
  IProtoRoot.org.eclipse.tahu.protobuf.Payload.IPropertyValue;
type IPropertySet = IProtoRoot.org.eclipse.tahu.protobuf.Payload.IPropertySet;
type IPropertySetList =
  IProtoRoot.org.eclipse.tahu.protobuf.Payload.IPropertySetList;
...
export interface UPropertyValue extends Omit<IPropertyValue, "type"> {
  // TODO is the type supposed to be like the metric type in the readme?
  value:
    | null
    | number
    | Long.Long
...
function getValue<T extends UserValue>(
  ...
  switch (type) {
    ...
    case 20: // PropertySet
      return decodePropertySet(
        (object as IPropertyValue).propertysetValue!
      ) as T;
    case 21:
      return decodePropertySetList(
        (object as IPropertyValue).propertysetsValue!
      ) as T;
    default:
      return null;
  }
...
function encodeDataSet(
  object: UDataSet
): ProtoRoot.org.eclipse.tahu.protobuf.Payload.DataSet {
...
function encodeMetaData(
  object: IMetaData
): ProtoRoot.org.eclipse.tahu.protobuf.Payload.MetaData {
...
function encodePropertyValue(
  object: UPropertyValue
): ProtoRoot.org.eclipse.tahu.protobuf.Payload.PropertyValue {
...
function encodePropertySet(
  object: Record<string, UPropertyValue>
): ProtoRoot.org.eclipse.tahu.protobuf.Payload.PropertySet {
  const keys = [],
    values = [];
...
function decodePropertySet(
  protoSet: IPropertySet
): Record<string, UPropertyValue> {
...
function encodePropertySetList(
  object: Record<string, UPropertyValue>[]
): ProtoRoot.org.eclipse.tahu.protobuf.Payload.PropertySetList {
...
function encodeParameter(
  object: UParameter
): ProtoRoot.org.eclipse.tahu.protobuf.Payload.Template.Parameter {
...
function encodeTemplate(
  object: UTemplate
): ProtoRoot.org.eclipse.tahu.protobuf.Payload.Template {
...
function encodeMetric(
  metric: UMetric
): ProtoRoot.org.eclipse.tahu.protobuf.Payload.Metric {
